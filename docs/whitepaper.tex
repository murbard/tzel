...
\texttt{configure\_verifier} messages may rotate program hashes, but
any attempt to change \(auth\_domain\) is rejected, even on a
still-pristine ledger. Other verifier-config fields remain rotatable
while pristine.
