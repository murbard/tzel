...
inclusion costs they pay. Publishers therefore gate inclusion off-chain
on \(producer\_otag\) matching an address they control — a wallet that
routes fees elsewhere simply does not get bundled. The kernel
intentionally does not cross-check the producer receiver against any
on-chain value: enforcement lives at the publisher, where it belongs.
